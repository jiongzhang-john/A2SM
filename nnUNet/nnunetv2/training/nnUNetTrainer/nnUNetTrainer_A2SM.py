...
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.A2SM import A2SM
...
class nnUNetTrainer_A2SM(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        segmentation_network_class_name = 'A2SM' #configuration_manager.UNet_class_name
        mapping = {'A2SM': A2SM}
        kwargs = {
            'conv_bias': True,
